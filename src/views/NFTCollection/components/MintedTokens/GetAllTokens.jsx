...
import { getCandyMachineCreator } from '../CandyMachineSection/CandyMachine/components/MintToken/candy-machine';
...
export default function GetAllTokens() {
    ...
    const getMintAddresses = async (firstCreatorAddress) => {
        ...
        const dataX = metadataAccounts.map((metadataAccountInfo) => bs58.encode(metadataAccountInfo.account.data));
        setData(dataX);
        return dataX;
    };
